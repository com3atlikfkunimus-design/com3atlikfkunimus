...
export default function PreTestPage() {
  ...
  const { athleteProfile, setAbqResults, saveAthleteWithAbq, isSaving } = useStudy();
  ...
  const handleSave = async (updatedAnswers, score) => {
    ...
    try {
      setAbqResults(updatedAnswers, score);
      await saveAthleteWithAbq(athleteProfile, updatedAnswers, score);
      setSubmitted(true);
    } catch (err) {
    ...
    return (
      ...
      >
        ...
        <div className="max-w-xl mx-auto text-center">
          ...
          <h1 className="text-xl font-bold text-slate-900 mb-2">Pre-Test Selesai</h1>
          <p className="text-slate-400 text-xs mb-8 font-medium">
            Data profil dan asesmen untuk <span className="text-slate-800 font-bold">{athleteProfile.name}</span> disimpan dengan aman.
          </p>
          ...
          <div className="glass-panel border border-[#e2e8f0]/80 rounded-2xl p-8 text-left mb-8 shadow-premium space-y-6 relative z-10 hover-lift transition-all duration-300">
            ...
            <div className="space-y-3.5 text-sm text-slate-600">
              ...
              <div className="flex justify-between py-1.5 pt-4">
                <div>
                  <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">Skor Burnout ABQ</span>
          ...
          <button
            ...
            "
          >
            Mulai Sesi 1: Tes Fisik Pre-Terapi
  ...
  return (
    ...
    >
      ...
      <div className="max-w-xl mx-auto">
        <ABQQuestionnaire
          title="Kuesioner Pre-Test ABQ"
          subtitle={`Asesmen Athlete Burnout Questionnaire untuk ${athleteProfile.name}.`}
